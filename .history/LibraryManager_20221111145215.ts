...
export class LibraryManager {
    ...
    public searchCode(codes: number): void {
        // this.books.forEach(document => document.code === codes)
        // this.magazines.filter(document => document.code === codes)
        // this.newspapers.filter(document => document.code === codes)
        this.newspapers.filter(document => document.code
    }
