...
export class LibraryManager {
    ...
    public searchDocuments(name: string): void {
        this.books.forEach(book => book.searchDocuments());
        this.magazines.forEach(magazine => magazine.searchDocuments());
        this.newspapers.forEach(newspaper => newspaper.searchDocuments());
    }

    public searchCode(codes: number): void {
        this.books.filter(document => document.code === codes )
    }
